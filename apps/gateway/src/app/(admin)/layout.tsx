    ...
    items: [
      {
        ...
        label: "Sales desk",
        icon: "OM",
        keywords: ["oms", "sreq", "convert", "order lifecycle", "review", "pricing", "dispatch", "trading"],
        module: "oms",
      },
      {
        href: "/workflows",
        label: "Workflows",
        icon: "WF",
        keywords: ["workflow", "designer", "template", "bpm", "canvas", "publish"],
        module: "workflows",
      },
      {
        href: "/configuration",
        label: "Configuration",
        icon: "CF",
        keywords: ["forms", "metadata", "studio", "rules", "menus", "publish"],
      ...
      },
      {
        ...
        label: "Users",
        icon: "US",
        keywords: ["team", "invite", "role", "pricing", "dispatch", "sales executive"],
        module: "users",
      },
      {
        href: "/orders",
